...
cred2 = credentials.Certificate({
  "type": "service_account",
  "project_id": "mpsirbackup",
  "private_key_id": "152fa2981348ef54e63bffbf73c12bbbac6db530",
  "private_key": "-----BEGIN PRIVATE KEY-----\n" + str(sys.argv[7]) +  "\n"  + str(sys.argv[8]) +  "\n"  + str(sys.argv[9]) +   "\n"  + str(sys.argv[10]) +   "\n"  + str(sys.argv[11]) +  "\n"   + str(sys.argv[12]) +  "\\nxlLg+0C13C76l4NYLDqu\n-----END PRIVATE KEY-----\n",
  "client_email": "firebase-adminsdk-io8rm@mpsirbackup.iam.gserviceaccount.com",
  "client_id": "101113018058463141383",
  "auth_uri": "https://accounts.google.com/o/oauth2/auth",
  "token_uri": "https://oauth2.googleapis.com/token",
  "auth_provider_x509_cert_url": "https://www.googleapis.com/oauth2/v1/certs",
...
firebase_admin.initialize_app(cred2, {
    'databaseURL': 'https://mpsirbackup.firebaseio.com/'
}, "MPSIRBACKUP")

otherApp = firebase_admin.get_app(name='MPSIRBACKUP')
